module FastlaneCI
  ...
  class Interface
    ...
    #   FastlaneCI can recover (much magic)
    #
    ...
    #   ENV["FASTLANE_CI_VERBOSE"] exists
    #
    ...
    def not_implemented(method_sym)
      require_relative "ui"
      UI.user_error!("Current UI '#{self}' doesn't support method '#{method_sym}'")
    end
